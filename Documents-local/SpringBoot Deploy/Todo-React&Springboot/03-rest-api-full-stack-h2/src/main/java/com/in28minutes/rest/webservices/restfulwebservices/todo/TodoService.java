...
public class TodoService {
	...
	static {
		todos.add(new Todo(++todosCount, "testuser","Get AWS Certified",
				LocalDate.now().plusYears(10)));
		todos.add(new Todo(++todosCount, "testuser","Learn DevOps",
				LocalDate.now().plusYears(11)));
		todos.add(new Todo(++todosCount, "testuser","Learn Full Stack Development",
